#!/usr/bin/env python3
"""
Stage 2 - Aster DEX execution probe (testnet by default).

Mainnet is refused unless --i-know-mainnet is passed, and per CLAUDE.md that flag is
only ever used after the user says 「上主网」 in the current conversation.
